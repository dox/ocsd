      ...
      <div class="row align-items-center">
        <div class="col-auto">
          ...
          <div class="page-pretitle">
            LDAP Filter: <?php echo $_GET['samaccountname'];?>
          </div>
          <h2 class="page-title">
            <?php echo $ldapPerson->cn; ?>
          </h2>
        </div>
        <!-- Page title actions -->
      ...
      <div class="col-md-6 col-xl-3">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="lh-sm">
              <div class="strong"><?php echo date('Y-m-d', w32timeToTime($ldapPerson->pwdlastset)); ?></div>
      ...
      <div class="col-md-6 col-xl-3">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="lh-sm">
              <div class="strong"><?php echo date('Y-m-d', w32timeToTime($ldapPerson->lastlogon)); ?></div>
