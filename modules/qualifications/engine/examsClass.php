<?php
class Exams {
	protected static $studentexams_table_name = "student_exams";
	protected static $examtypes_table_name = "exam_types";
	protected static $exampapers_table_name = "student_exam_papers";
	protected static $qualclasses_table_name = "qual_classes";
