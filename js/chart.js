!function(t) {
    ...
    return function t(e, i, a) {
            ...
            function a(t) {
                if (t) {
                    ...
                    for (var u = 0; u < r.length; u++)
                        r[u] = d(r[u], 0, 255);
                    return l = l || 0 == l ? d(l, 0, 1) : 1, r[3] = l, r
                }
            }
            function n(t) {
                if (t) {
                    ...
                    if (i) {
                        ...
                        return [d(parseInt(i[1]), 0, 360), d(parseFloat(i[2]), 0, 100), d(parseFloat(i[3]), 0, 100), d(isNaN(a) ? 1 : a, 0, 1)]
                    }
                }
            }
            function o(t) {
            ...
            o.prototype = {
                ...
                clone: function() {
                    var t,
                        ...
                        n = i.values;
                    for (var r in a)
                        a.hasOwnProperty(r) && (t = a[r], "[object Array]" === (e = {}.toString.call(t)) ? n[r] = t.slice(0) : "[object Number]" === e ? n[r] = t : console.error("unexpected color value:", t));
                    return i
                }
            }, o.prototype.spaces = {
                rgb: ["red", "green", "blue"],
        ...
        4: [function(t, e, i) {
            function a(t) {
                var e,
                    ...
                    s = Math.max(n, o, r),
                    d = s - l;
                return s == l ? e = 0 : n == s ? e = (o - r) / d : o == s ? e = 2 + (r - n) / d : r == s && (e = 4 + (n - o) / d), (e = Math.min(60 * e, 360)) < 0 && (e += 360), a = (l + s) / 2, i = s == l ? 0 : a <= .5 ? d / (s + l) : d / (2 - s - l), [e, 100 * i, 100 * a]
            }
            function n(t) {
                var e,
                    i,
                    ...
                    s = Math.max(n, o, r),
                    d = s - l;
                return i = 0 == s ? 0 : d / s * 1e3 / 10, s == l ? e = 0 : n == s ? e = (o - r) / d : o == s ? e = 2 + (r - n) / d : r == s && (e = 4 + (n - o) / d), (e = Math.min(60 * e, 360)) < 0 && (e += 360), a = s / 255 * 1e3 / 10, [e, i, a]
            }
            function o(t) {
                var e = t[0],
                    i = t[1],
            ...
            function d(t) {
                var e = t[0] / 255,
                    i = t[1] / 255,
                    a = t[2] / 255;
                return [100 * (.4124 * (e = e > .04045 ? Math.pow((e + .055) / 1.055, 2.4) : e / 12.92) + .3576 * (i = i > .04045 ? Math.pow((i + .055) / 1.055, 2.4) : i / 12.92) + .1805 * (a = a > .04045 ? Math.pow((a + .055) / 1.055, 2.4) : a / 12.92)), 100 * (.2126 * e + .7152 * i + .0722 * a), 100 * (.0193 * e + .1192 * i + .9505 * a)]
            }
            function u(t) {
                var e,
                    i,
            ...
            function c(t) {
                ...
                e = 2 * s - (i = s < .5 ? s * (1 + l) : s + l - s * l), n = [0, 0, 0];
                for (var d = 0; d < 3; d++)
                    (a = r + 1 / 3 * -(d - 1)) < 0 && a++, a > 1 && a--, o = 6 * a < 1 ? e + 6 * (i - e) * a : 2 * a < 1 ? i : 3 * a < 2 ? e + (i - e) * (2 / 3 - a) * 6 : e, n[d] = 255 * o;
                return n
            }
            function h(t) {
                var e = t[0] / 60,
            ...
            function x(t) {
                var e,
                    ...
                    r = t[1],
                    l = t[2];
                return o <= 8 ? n = (i = 100 * o / 903.3) / 100 * 7.787 + 16 / 116 : (i = 100 * Math.pow((o + 16) / 116, 3), n = Math.pow(i / 100, 1 / 3)), e = e / 95.047 <= .008856 ? e = 95.047 * (r / 500 + n - 16 / 116) / 7.787 : 95.047 * Math.pow(r / 500 + n, 3), a = a / 108.883 <= .008859 ? a = 108.883 * (n - l / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(n - l / 200, 3), [e, i, a]
            }
            function y(t) {
                var e,
                    i,
                    ...
                    o = t[1],
                    r = t[2];
                return e = Math.atan2(r, o), (i = 360 * e / 2 / Math.PI) < 0 && (i += 360), a = Math.sqrt(o * o + r * r), [n, a, i]
            }
            function k(t) {
                return m(x(t))
            }
            function S(t) {
                var e,
                    ...
                    n = t[0],
                    o = t[1];
                return a = t[2] / 360 * 2 * Math.PI, e = o * Math.cos(a), i = o * Math.sin(a), [n, e, i]
            }
            function w(t) {
                return M[t]
            }
                ...
                t.defaults.bar = {
                    ...
                    getBarCount: function() {
                        ...
                        return e.each(t.chart.data.datasets, function(e, a) {
                            t.chart.getDatasetMeta(a).bar && t.chart.isDatasetVisible(a) && ++i
                        }, t), i
                    },
                    update: function(t) {
                        var i = this;
                    ...
                    getRuler: function(t) {
                        var e,
                            ...
                            o = i.getBarCount(),
                            r = (e = "category" === n.options.type ? n.getPixelForTick(t + 1) - n.getPixelForTick(t) : n.width / n.ticks.length) * n.options.categoryPercentage,
                            l = (e - e * n.options.categoryPercentage) / 2,
                            s = r / o;
                        return n.ticks.length !== i.chart.data.labels.length && (s *= n.ticks.length / i.chart.data.labels.length), {
                            datasetCount: o,
                            tickWidth: e,
                            categoryWidth: r,
                            categorySpacing: l,
                            fullBarWidth: s,
                            barWidth: s * n.options.barPercentage,
                            barSpacing: s - s * n.options.barPercentage
                        }
                    },
                    ...
                    getBarIndex: function(t) {
                        var e,
                            i = 0;
                        for (e = 0; e < t; ++e)
                            this.chart.getDatasetMeta(e).bar && this.chart.isDatasetVisible(e) && ++i;
                        return i
                    },
                    ...
                    updateElement: function(t, i, a) {
                        ...
                        t._model = {
                            ...
                            var s = [[i.base, o], [i.base, n], [r, n], [r, o]],
                                d = ["bottom", "left", "top", "right"].indexOf(i.borderSkipped, 0);
                            -1 === d && (d = 0), e.moveTo.apply(e, t(0));
                            for (var u = 1; u < 4; u++)
                                e.lineTo.apply(e, t(u));
                    ...
                    getRuler: function(t) {
                        ...
                        return n.ticks.length !== i.chart.data.labels.length && (s *= n.ticks.length / i.chart.data.labels.length), {
                            ...
                            categorySpacing: l,
                            fullBarHeight: s,
                            barHeight: s * n.options.barPercentage,
                            barSpacing: s - s * n.options.barPercentage
                        }
                    },
                ...
                t.defaults.bubble = {
                    ...
                    setHoverStyle: function(i) {
                        ...
                        var n = a.chart.data.datasets[i._datasetIndex],
                            o = i._index,
                            r = i.custom || {};
                        i._model.radius = r.hoverRadius ? r.hoverRadius : e.getValueAtIndexOrDefault(n.hoverRadius, o, a.chart.options.elements.point.hoverRadius) + a.getRadius(n.data[o])
                    },
                    removeHoverStyle: function(e) {
                        ...
                        var a = i.chart.data.datasets[e._datasetIndex].data[e._index],
                            n = e.custom || {};
                        e._model.radius = n.radius ? n.radius : i.getRadius(a)
                    }
                })
            }
        }, {}],
            ...
            e.exports = function(t) {
                ...
                i.doughnut = {
                    ...
                    legend: {
                        labels: {
                            generateLabels: function(t) {
                                ...
                                return i.labels.length && i.datasets.length ? i.labels.map(function(a, n) {
                                    ...
                                    return {
                                        text: a,
                                        fillStyle: s.backgroundColor ? s.backgroundColor : d(r.backgroundColor, n, u.backgroundColor),
                                        strokeStyle: s.borderColor ? s.borderColor : d(r.borderColor, n, u.borderColor),
                                        lineWidth: s.borderWidth ? s.borderWidth : d(r.borderWidth, n, u.borderWidth),
                        ...
                        onClick: function(t, e) {
                            ...
                            for (i = 0, a = (r.data.datasets || []).length; i < a; ++i)
                                (n = r.getDatasetMeta(i)).data[o] && (n.data[o].hidden = !n.data[o].hidden);
                            r.update()
                        }
                    },
                    cutoutPercentage: 50,
                    ...
                    tooltips: {
                        callbacks: {
                            ...
                            label: function(t, i) {
                                ...
                                return e.isArray(a) ? (a = a.slice())[0] += n : a += n, a
                            }
                        }
                    }
                    ...
                    updateElement: function(t, i, a) {
                        ...
                        var v = t._model;
                        this.removeHoverStyle(t), a && s.animateRotate || (v.startAngle = 0 === i ? l.rotation : n.getMeta().data[i - 1]._model.endAngle, v.endAngle = v.startAngle + v.circumference), t.pivot()
                    },
                    removeHoverStyle: function(e) {
                    ...
                    getMaxBorderWidth: function(t) {
                        for (var e, i, a = 0, n = this.index, o = t.length, r = 0; r < o; r++)
                            e = t[r]._model ? t[r]._model.borderWidth : 0, a = (i = t[r]._chart ? t[r]._chart.config.data.datasets[n].hoverBorderWidth : 0) > (a = e > a ? e : a) ? i : a;
                        return a
                    }
                })
            }
                ...
                t.defaults.line = {
                    ...
                    updateElement: function(t, e, a) {
                        var n,
                            ...
                            p = 1 === (r.chart.data.labels || []).length || 1 === d.data.length || r.chart.isCombo;
                        void 0 !== d.radius && void 0 === d.pointRadius && (d.pointRadius = d.radius), void 0 !== d.hitRadius && void 0 === d.pointHitRadius && (d.pointHitRadius = d.hitRadius), n = f.getPixelForValue("object" == typeof c ? c : NaN, e, u, p), o = a ? h.getBasePixel() : r.calculatePointY(c, e, u), t._xScale = f, t._yScale = h, t._datasetIndex = u, t._index = e, t._model = {
                            x: n,
                            y: o,
                    ...
                    calculatePointY: function(t, e, i) {
                        ...
                        if (d.options.stacked) {
                            for (a = 0; a < i; a++)
                                if (n = l.data.datasets[a], "line" === (o = l.getDatasetMeta(a)).type && o.yAxisID === d.id && l.isDatasetVisible(a)) {
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        if (l.dataset._model.spanGaps && (d = d.filter(function(t) {
                            ...
                            i.splineCurveMonotone(d);
                        else
                            for (e = 0, a = d.length; e < a; ++e)
                                n = d[e]._model, o = i.splineCurve(i.previousItem(d, e)._model, n, i.nextItem(d, e)._model, l.dataset._model.tension), n.controlPointPreviousX = o.previous.x, n.controlPointPreviousY = o.previous.y, n.controlPointNextX = o.next.x, n.controlPointNextY = o.next.y;
                        if (r.chart.options.elements.line.capBezierPoints)
                            for (e = 0, a = d.length; e < a; ++e)
                                (n = d[e]._model).controlPointPreviousX = t(n.controlPointPreviousX, s.left, s.right), n.controlPointPreviousY = t(n.controlPointPreviousY, s.top, s.bottom), n.controlPointNextX = t(n.controlPointNextX, s.left, s.right), n.controlPointNextY = t(n.controlPointNextY, s.top, s.bottom)
                    },
                    draw: function(t) {
                        var i,
                            a,
                    ...
                    legend: {
                        labels: {
                            generateLabels: function(t) {
                                ...
                                return i.labels.length && i.datasets.length ? i.labels.map(function(a, n) {
                                    ...
                                    return {
                                        text: a,
                                        fillStyle: l.backgroundColor ? l.backgroundColor : s(r.backgroundColor, n, d.backgroundColor),
                                        strokeStyle: l.borderColor ? l.borderColor : s(r.borderColor, n, d.borderColor),
                                        lineWidth: l.borderWidth ? l.borderWidth : s(r.borderWidth, n, d.borderWidth),
                                        hidden: isNaN(r.data[n]) || o.data[n].hidden,
                                        index: n
                                    }
                                }) : []
                        ...
                        onClick: function(t, e) {
                            var i,
                                ...
                                r = this.chart;
                            for (i = 0, a = (r.data.datasets || []).length; i < a; ++i)
                                (n = r.getDatasetMeta(i)).data[o].hidden = !n.data[o].hidden;
                            r.update()
                        }
                    },
                    tooltips: {
        ...
        22: [function(t, e, i) {
            "use strict";
            e.exports = function(t) {
                (t.canvasHelpers = {}).drawPoint = function(t, e, i, a, n) {
                    var o,
                        r,
                        l,
                        s,
                    ...
                    if ("object" != typeof e || "[object HTMLImageElement]" !== (o = e.toString()) && "[object HTMLCanvasElement]" !== o) {
                        ...
                        t.drawImage(e, a - e.width / 2, n - e.height / 2)
                }
            }
        }, {}],
        23: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function(e, i, a) {
                    ...
                    render: function(e, i) {
                        ...
                        if (n && (void 0 !== e && 0 !== e || void 0 === e && 0 !== n.duration)) {
                    ...
                    destroy: function() {
                        ...
                        for (o.stop(), i = 0, n = o.data.datasets.length; i < n; ++i)
                            (e = o.getDatasetMeta(i)).controller && (e.controller.destroy(), e.controller = null);
                    ...
                    updateHoverStyle: function(t, e, i) {
                        ...
                        for (n = 0, o = t.length; n < o; ++n)
                            (a = t[n]) && this.getDatasetMeta(a._datasetIndex).controller[r](a)
                    },
            ...
            e.exports = function(t) {
                ...
                function i(t, e) {
                    ...
                    if (i) {
                        var a = i.listeners,
                            o = a.indexOf(e);
                        -1 !== o && a.splice(o, 1), a.length > 0 || (n.forEach(function(e) {
                            delete t[e]
                        }), delete t._chartjs)
                    }
                }
                        ...
                        return i._view || (i._view = e.clone(i._model)), 1 === t ? (i._view = i._model, i._start = null, i) : (i._start || i.pivot(), e.each(i._model, function(a, n) {
                            if ("_" === n[0])
                                ...
                                if (a === i._view[n])
                                    ...
                                    var r = void 0 !== i._start[n] && !1 === isNaN(i._start[n]) ? i._start[n] : 0;
                                    i._view[n] = (i._model[n] - r) * t + r
                                } else
                                    i._view[n] = a;
                            else
            ...
            e.exports = function(t) {
                ...
                o.each = function(t, e, i, a) {
                    ...
                    return o.each(t, function(t, i) {
                        o.isArray(t) ? e[i] = t.slice(0) : e[i] = "object" == typeof t && null !== t ? o.clone(t) : t
                    }), e
                }, o.extend = function(t) {
                    for (var e = 1, i = arguments.length; e < i; e++)
                        o.each(arguments[e], function(e, i) {
                            t[i] = e
                        });
                    return t
                    ...
                    var e,
                        ...
                        l = r.length;
                    for (e = 0; e < l; ++e)
                        (a = r[e]).model.skip || (i = e > 0 ? r[e - 1] : null, (n = e < l - 1 ? r[e + 1] : null) && !n.model.skip && (a.deltaK = (n.model.y - a.model.y) / (n.model.x - a.model.x)), !i || i.model.skip ? a.mK = a.deltaK : !n || n.model.skip ? a.mK = i.deltaK : this.sign(i.deltaK) !== this.sign(a.deltaK) ? a.mK = 0 : a.mK = (i.deltaK + a.deltaK) / 2);
                    var s,
                        d,
                        u,
                        c;
                    for (e = 0; e < l - 1; ++e)
                        a = r[e], n = r[e + 1], a.model.skip || n.model.skip || (o.almostEquals(a.deltaK, 0, this.EPSILON) ? a.mK = n.mK = 0 : (s = a.mK / a.deltaK, d = n.mK / a.deltaK, (c = Math.pow(s, 2) + Math.pow(d, 2)) <= 9 || (u = 3 / Math.sqrt(c), a.mK = s * u * a.deltaK, n.mK = d * u * a.deltaK)));
                    var h;
                    for (e = 0; e < l; ++e)
                        (a = r[e]).model.skip || (i = e > 0 ? r[e - 1] : null, n = e < l - 1 ? r[e + 1] : null, i && !i.model.skip && (h = (a.model.x - i.model.x) / 3, a.model.controlPointPreviousX = a.model.x - h, a.model.controlPointPreviousY = a.model.y - h * a.mK), n && !n.model.skip && (h = (n.model.x - a.model.x) / 3, a.model.controlPointNextX = a.model.x + h, a.model.controlPointNextY = a.model.y + h * a.mK))
                ...
                var r = o.easingEffects = {
                    ...
                    easeInOutElastic: function(t) {
                        var e = 1.70158,
                            i = 0,
                            a = 1;
                        return 0 === t ? 0 : 2 == (t /= .5) ? 1 : (i || (i = .3 * 1.5 * 1), a < Math.abs(1) ? (a = 1, e = i / 4) : e = i / (2 * Math.PI) * Math.asin(1 / a), t < 1 ? a * Math.pow(2, 10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / i) * -.5 : a * Math.pow(2, -10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / i) * .5 + 1)
                    },
                ...
                o.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
                ...
                }, o.cancelAnimFrame = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.oCancelAnimationFrame || window.msCancelAnimationFrame || function(t) {
                    ...
                    var l = 0;
                    o.each(i, function(e) {
                        void 0 !== e && null !== e && !0 !== o.isArray(e) ? l = o.measureText(t, n, r, l, e) : o.isArray(e) && o.each(e, function(e) {
            ...
            e.exports = function(t) {
                function e(t, e) {
                    var i,
                        ...
                        o,
                        r;
                    for (a = 0, o = t.data.datasets.length; a < o; ++a)
                        if (t.isDatasetVisible(a))
                            for (n = 0, r = (i = t.getDatasetMeta(a)).data.length; n < r; ++n) {
                                var l = i.data[n];
                                l._view.skip || e(l)
                            }
                }
                ...
                function n(t, e, n) {
                    var r = o.getRelativePosition(e, t.chart),
                        l = n.intersect ? i(t, r) : a(t, r, !1, function(t, e) {
                            return Math.abs(t.x - e.x)
                        }),
                        s = [];
                    return l.length ? (t.data.datasets.forEach(function(e, i) {
                        if (t.isDatasetVisible(i)) {
                            var a = t.getDatasetMeta(i).data[l[0]._index];
                ...
                t.Interaction = {
                    modes: {
                        ...
                        point: function(t, e) {
                            return i(t, o.getRelativePosition(e, t.chart))
                        },
                        nearest: function(t, e, i) {
                            var n = a(t, o.getRelativePosition(e, t.chart), i.intersect);
                            return n.length > 1 && n.sort(function(t, e) {
                        ...
                        function n(t) {
                            ...
                            if (i)
                                if (t.isHorizontal()) {
                                    ...
                                    t.update(t.options.fullWidth ? b : S, v / 2, a)
                                } else
                                    t.update(i.minSize.width, w)
                        }
                        function o(t) {
                            t.isHorizontal() ? (t.left = t.options.fullWidth ? s : C, t.right = t.options.fullWidth ? i - d : C + S, t.top = _, t.bottom = _ + t.height, _ = t.bottom) : (t.left = F, t.right = F + t.width, t.top = I, t.bottom = I + w, F = t.right)
                        }
                        if (t) {
                            var r = t.options.layout,
                                ...
                                u = 0,
                                c = 0;
                            isNaN(l) ? (s = l.left || 0, d = l.right || 0, u = l.top || 0, c = l.bottom || 0) : (s = l, d = l, u = l, c = l);
                            ...
                            var b = i - s - d,
                                v = a - u - c,
                                x = v / 2,
                                y = (i - b / 2) / (h.length + f.length),
                                k = (a - x) / (g.length + p.length),
                                S = b,
                                w = v,
                                M = [];
                            e.each(h.concat(f, g, p), function(t) {
                                var e,
                                    i = t.isHorizontal();
                                i ? (e = t.update(t.options.fullWidth ? b : S, k), w -= e.height) : (e = t.update(y, x), S -= e.width), M.push({
                                    horizontal: i,
                                    minSize: e,
                                    box: t
                                })
                            ...
                            e.each(h.concat(f), n), e.each(h, function(t) {
                                ...
                                i && t.update(i.minSize.width, w, a)
                            }), C = s, D = d, I = u, A = c, e.each(h, function(t) {
                                C += t.width
                            }), e.each(f, function(t) {
                                D += t.width
                            }), e.each(g, function(t) {
                            ...
                            var F = s,
                                _ = u;
                            e.each(h.concat(g), o), F += S, _ += w, e.each(f, o), e.each(p, o), t.chartArea = {
                                left: C,
                                top: I,
                                right: C + S,
                                bottom: I + w
                            }, e.each(m, function(e) {
                                e.left = t.chartArea.left, e.top = t.chartArea.top, e.right = t.chartArea.right, e.bottom = t.chartArea.bottom, e.update(S, w)
                            })
                        }
                    }
                }
                        ...
                        if (m ? (p.width = a.maxWidth, p.height = r ? 10 : 0) : (p.width = r ? 10 : 0, p.height = a.maxHeight), r)
                            if (l.font = f, m) {
                                ...
                                l.textAlign = "left", l.textBaseline = "top", i.each(a.legendItems, function(t, i) {
                                    var n = e(o, u) + u / 2 + l.measureText(t.text).width;
                                    b[b.length - 1] + n + o.padding >= a.width && (v += u + o.padding, b[b.length] = a.left), g[i] = {
                                        left: 0,
                                        top: 0,
                                        width: n,
                                        height: u
                                    }, b[b.length - 1] += n + o.padding
                                }), p.height += v
                            } else {
                                var x = o.padding,
                                    y = a.columnWidths = [],
                                ...
                                i.each(a.legendItems, function(t, i) {
                                    var a = e(o, u) + u / 2 + l.measureText(t.text).width;
                                    w + M > p.height && (k += S + o.padding, y.push(S), S = 0, w = 0), S = Math.max(S, a), w += M, g[i] = {
                                        left: 0,
                                        top: 0,
                                        width: a,
                                        height: u
                ...
                t.plugins = {
                    ...
                    notify: function(t, e) {
                        var i,
                            ...
                            o = n.length;
                        for (i = 0; i < o; ++i)
                            if ("function" == typeof (a = n[i])[t] && !1 === a[t].apply(a, e || []))
                                return !1;
                        return !0
                    }
            ...
            e.exports = function(t) {
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function() {
                        ...
                        if (i.labelRotation = o.minRotation || 0, i.paddingRight = 0, i.paddingLeft = 0, i.options.display && i.isHorizontal()) {
                            ...
                            for (var f, g, p = e.longestText(a, d, i.ticks, i.longestTextCache), m = p, b = i.getPixelForTick(1) - i.getPixelForTick(0) - 6; m > b && i.labelRotation < o.maxRotation;) {
                                if (f = Math.cos(e.toRadians(i.labelRotation)), g = Math.sin(e.toRadians(i.labelRotation)), (u = f * c) + r / 2 > i.yLabelWidth && (i.paddingLeft = u + r / 2), i.paddingRight = r / 2, g * p > i.maxHeight) {
                                    i.labelRotation--;
                                    break
                                }
                    ...
                    fit: function() {
                        ...
                        if (a.width = u ? i.isFullWidth() ? i.maxWidth - i.margins.left - i.margins.right : i.maxWidth : d && s.drawTicks ? m : 0, a.height = u ? d && s.drawTicks ? m : 0 : i.maxHeight, l.display && d && (u ? a.height += 1.5 * p : a.width += 1.5 * p), r.display && d) {
                            ...
                            if (u) {
                                ...
                                r.mirror ? b = 0 : b += i.options.ticks.padding, b < C ? a.width += b : a.width = i.maxWidth, i.paddingTop = c / 2, i.paddingBottom = c / 2
                            }
                        }
                        ...
                        if (n.display) {
                            ...
                            if (e.each(a.ticks, function(t, r) {
                                if (void 0 !== t && null !== t) {
                                    ...
                                    if ((!(o > 1 && r % o > 0 || r % o == 0 && r + o >= a.ticks.length) || l) && void 0 !== t && null !== t) {
                                        var s,
                                            c;
                                        r === (void 0 !== a.zeroLineIndex ? a.zeroLineIndex : 0) ? (s = u.zeroLineWidth, c = u.zeroLineColor) : (s = e.getValueAtIndexOrDefault(u.lineWidth, r), c = e.getValueAtIndexOrDefault(u.color, r));
                                        var f,
                                            p,
                                            m,
                                            b,
                                            ...
                                            T = "middle";
                                        if (g) {
                                            h || (T = "top" === n.position ? "bottom" : "top"), I = h ? "right" : "center";
                                            var P = a.getPixelForTick(r) + e.aliasPixel(s);
                                            C = a.getPixelForTick(r, u.offsetGridLines) + d.labelOffset, D = h ? a.top + 12 : "top" === n.position ? a.bottom - y : a.top + y, f = m = v = w = P, p = V, b = L, x = i.top, M = i.bottom
                                        } else {
                                            "left" === n.position ? d.mirror ? (C = a.right + d.padding, I = "left") : (C = a.right - d.padding, I = "right") : d.mirror ? (C = a.left - d.padding, I = "right") : (C = a.left + d.padding, I = "left");
                                            var O = a.getPixelForTick(r);
                                            O += e.aliasPixel(s), D = a.getPixelForTick(r, u.offsetGridLines), f = _, m = R, v = i.left, w = i.right, p = b = x = M = O
                                        }
                                        F.push({
                                            tx1: f,
                                            ty1: p,
                ...
                t.Ticks = {
                    generators: {
                        linear: function(t, i) {
                            ...
                            t.min && t.max && t.stepSize && (t.max - t.min) % t.stepSize == 0 && (r = t.min, l = t.max);
                            var s = (l - r) / a;
                            s = e.almostEquals(s, Math.round(s), a / 1e3) ? Math.round(s) : Math.ceil(s), n.push(void 0 !== t.min ? t.min : r);
                            for (var d = 1; d < s; ++d)
                                n.push(r + d * a);
                ...
                t.defaults.global.tooltips = {
                    ...
                    getTitle: function() {
                        var t = this,
                            ...
                            a = e.beforeTitle.apply(t, arguments),
                    ...
                    update: function(e) {
                        ...
                        if (g.length) {
                            ...
                            }), f.title = u.getTitle(S, p), f.beforeBody = u.getBeforeBody(S, p), f.body = u.getBody(S, p), f.afterBody = u.getAfterBody(S, p), f.footer = u.getFooter(S, p), f.x = Math.round(y.x), f.y = Math.round(y.y), f.caretPadding = s.getValueOrDefault(y.padding, 2), f.labelColors = k, f.dataPoints = S, v = l(f, x = o(this, f), b = r(this, x))
                        } else
                            f.opacity = 0;
                    ...
                    drawCaret: function(t, i, a) {
                        var n,
                            ...
                            v = i.width,
                            x = i.height;
                        "center" === p ? ("left" === g ? (o = (n = m) - h, r = n) : (o = (n = m + v) + h, r = n), l = (s = b + x / 2) - h, d = s + h) : ("left" === g ? r = (o = (n = m + f) + h) + h : "right" === g ? r = (o = (n = m + v - f) - h) - h : (n = (o = m + v / 2) - h, r = o + h), "top" === p ? (s = (l = b) - h, d = l) : (s = (l = b + x) + h, d = l)), c.fillStyle = e(u.backgroundColor, a), c.beginPath(), c.moveTo(n, l), c.lineTo(o, s), c.lineTo(r, d), c.closePath(), c.fill()
                    },
            ...
            e.exports = function(t) {
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function() {
                        function t(t, e) {
                            var i = e._view;
                            !0 === e._view.steppedLine ? (s.lineTo(i.x, t._view.y), s.lineTo(i.x, i.y)) : 0 === e._view.tension ? s.lineTo(i.x, i.y) : s.bezierCurveTo(t._view.controlPointNextX, t._view.controlPointNextY, i.controlPointPreviousX, i.controlPointPreviousY, i.x, i.y)
                        }
                        var a = this,
                            n = a._view,
                            o = n.spanGaps,
                        ...
                        if (d.length && n.fill) {
                            ...
                            l || -1 === u || s.lineTo(d[u]._view.x, r), s.fillStyle = n.backgroundColor || i.defaultColor, s.closePath(), s.fill()
                        }
                ...
                a.elements.point = {
                    ...
                    draw: function() {
                        var e = this._view,
                            ...
                            s = e.x,
                            d = e.y;
                        e.skip || (o.strokeStyle = e.borderColor || n, o.lineWidth = i.getValueOrDefault(e.borderWidth, a.elements.point.borderWidth), o.fillStyle = e.backgroundColor || n, t.canvasHelpers.drawPoint(o, r, l, s, d))
                    }
                })
            }
        }, {}],
                ...
                a.elements.rectangle = {
                    ...
                    inLabelRange: function(t, a) {
                        ...
                        if (!n._view)
                            return !1;
                        var o = i(n);
                        return e(n) ? t >= o.left && t <= o.right : a >= o.top && a <= o.bottom
                    },
                    inXRange: function(t) {
                        var e = i(this);
                ...
                var e = t.helpers,
                    ...
                    a = t.Scale.extend({
                        ...
                        determineDataLimits: function() {
                            ...
                            var a;
                            void 0 !== t.options.ticks.min && (a = e.indexOf(i, t.options.ticks.min), t.minIndex = -1 !== a ? a : t.minIndex), void 0 !== t.options.ticks.max && (a = e.indexOf(i, t.options.ticks.max), t.maxIndex = -1 !== a ? a : t.maxIndex), t.min = i[t.minIndex], t.max = i[t.maxIndex]
                        },
                        buildTicks: function() {
                            var t = this,
                                e = t.getLabels();
                        ...
                        getPixelForValue: function(t, e, i, a) {
                            ...
                            if (n.isHorizontal()) {
                                var l = (n.width - (n.paddingLeft + n.paddingRight)) / o,
                                    s = l * (e - n.minIndex) + n.paddingLeft;
                                return (n.options.gridLines.offsetGridLines && a || n.maxIndex === n.minIndex && a) && (s += l / 2), n.left + Math.round(s)
                            }
                            var d = (n.height - (n.paddingTop + n.paddingBottom)) / o,
                                u = d * (e - n.minIndex) + n.paddingTop;
                            return n.options.gridLines.offsetGridLines && a && (u += d / 2), n.top + Math.round(u)
                        },
                        getPixelForTick: function(t, e) {
                        ...
                        getValueForPixel: function(t) {
                            var e = this,
                                ...
                                a = e.isHorizontal(),
                                n = (a ? e.width - (e.paddingLeft + e.paddingRight) : e.height - (e.paddingTop + e.paddingBottom)) / i;
                            return t -= a ? e.left : e.top, e.options.gridLines.offsetGridLines && (t -= n / 2), t -= a ? e.paddingLeft : e.paddingTop, t <= 0 ? 0 : Math.round(t / n)
                        },
                        getBasePixel: function() {
                            return this.bottom
                        }
            ...
            e.exports = function(t) {
                var e = t.helpers,
                    ...
                    a = t.LinearScaleBase.extend({
                        determineDataLimits: function() {
                            function t(t) {
                                return r ? t.xAxisID === i.id : t.yAxisID === i.id
                            }
                            var i = this,
                                a = i.options,
                                n = i.chart,
                            ...
                            if (i.min = null, i.max = null, a.stacked) {
                                ...
                                e.each(o, function(o, r) {
                                    ...
                                    n.isDatasetVisible(r) && t(s) && e.each(o.data, function(t, e) {
                                        ...
                                        isNaN(n) || s.data[e].hidden || (d[e] = d[e] || 0, u[e] = u[e] || 0, a.relativePoints ? d[e] = 100 : n < 0 ? u[e] += n : d[e] += n)
                                    })
                                }), e.each(l, function(t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    handleTickRangeOptions: function() {
                        ...
                        if (i.beginAtZero) {
                            var a = e.sign(t.min),
                                n = e.sign(t.max);
                            a < 0 && n < 0 ? t.max = 0 : a > 0 && n > 0 && (t.min = 0)
                        }
                    ...
                    buildTicks: function() {
                        var i = this,
                            ...
                            r = i.ticks = t.Ticks.generators.linear(o, i);
                        i.handleDirectionalChanges(), i.max = e.max(r), i.min = e.min(r), a.reverse ? (r.reverse(), i.start = i.max, i.end = i.min) : (i.start = i.min, i.end = i.max)
                    },
                    convertTicksToLabels: function() {
                        var e = this;
                    ...
                    a = t.Scale.extend({
                        determineDataLimits: function() {
                            ...
                            if (i.min = null, i.max = null, i.minNotZero = null, a.stacked) {
                                ...
                                e.each(r, function(n, r) {
                                    ...
                                    o.isDatasetVisible(r) && t(l) && (void 0 === d[l.type] && (d[l.type] = []), e.each(n.data, function(t, e) {
                                        var n = d[l.type],
                                            o = +i.getRightValue(t);
                            ...
                            i.min = l(n.min, i.min), i.max = l(n.max, i.max), i.min === i.max && (0 !== i.min && null !== i.min ? (i.min = Math.pow(10, Math.floor(e.log10(i.min)) - 1), i.max = Math.pow(10, Math.floor(e.log10(i.max)) + 1)) : (i.min = 1, i.max = 10))
                        },
                        buildTicks: function() {
                            var i = this,
                                a = i.options.ticks,
                                ...
                                o = i.ticks = t.Ticks.generators.logarithmic(n, i);
                            i.isHorizontal() || o.reverse(), i.max = e.max(o), i.min = e.min(o), a.reverse ? (o.reverse(), i.start = i.max, i.end = i.min) : (i.start = i.min, i.end = i.max)
                        },
                        convertTicksToLabels: function() {
                        ...
                        getPixelForValue: function(t) {
                            var i,
                                ...
                                u = o.paddingLeft,
                                c = o.options.ticks;
                            return o.isHorizontal() ? (n = e.log10(o.end) - e.log10(r), 0 === l ? a = o.left + u : (i = o.width - (u + o.paddingRight), a = o.left + i / n * (e.log10(l) - e.log10(r)), a += u)) : (i = o.height - (s + d), 0 !== r || c.reverse ? 0 === o.end && c.reverse ? (n = e.log10(o.start) - e.log10(o.minNotZero), a = l === o.end ? o.top + s : l === o.minNotZero ? o.top + s + .02 * i : o.top + s + .02 * i + .98 * i / n * (e.log10(l) - e.log10(o.minNotZero))) : (n = e.log10(o.end) - e.log10(r), i = o.height - (s + d), a = o.bottom - d - i / n * (e.log10(l) - e.log10(r))) : (n = e.log10(o.end) - e.log10(o.minNotZero), a = l === r ? o.bottom - d : l === o.minNotZero ? o.bottom - d - .02 * i : o.bottom - d - .02 * i - .98 * i / n * (e.log10(l) - e.log10(o.minNotZero)))), a
                        },
                        getValueForPixel: function(t) {
                            var i,
                                a,
                    ...
                    n = t.LinearScaleBase.extend({
                        ...
                        fit: function() {
                            ...
                            for (this.ctx.font = v, a = 0; a < this.getValueCount(); a++) {
                                ...
                                var S = 360 * (this.getIndexAngle(a) + Math.PI / 2) / (2 * Math.PI) % 360;
                                0 === S || 180 === S ? (o = n / 2, t.x + o > y && (y = t.x + o, r = a), t.x - o < k && (k = t.x - o, s = a)) : S < 180 ? t.x + n > y && (y = t.x + n, r = a) : t.x - n < k && (k = t.x - n, s = a)
                            }
                            ...
                            if (a.display) {
                                ...
                                if (e.each(t.ticks, function(r, l) {
                                    ...
                                    for (var g = t.getDistanceFromCenterForValue(a.reverse ? t.min : t.max), p = s(l.fontSize, i.defaultFontSize), m = s(l.fontStyle, i.defaultFontStyle), b = s(l.fontFamily, i.defaultFontFamily), v = e.fontString(p, m, b), x = t.getValueCount() - 1; x >= 0; x--) {
                                        ...
                                        var w = t.pointLabels,
                                            M = 360 * (this.getIndexAngle(x) + Math.PI / 2) / (2 * Math.PI) % 360;
                                        d.textAlign = 0 === M || 180 === M ? "center" : M < 180 ? "left" : "right", d.textBaseline = 90 === M || 270 === M ? "middle" : M > 270 || M < 90 ? "bottom" : "top", d.fillText(w[x] ? w[x] : "", k.x, k.y)
                                    }
                                }
                            }
                        }
                    ...
                    o = t.Scale.extend({
                        ...
                        buildTicks: function() {
                            ...
                            if (a.ctx.font = l, a.ticks = [], a.unitScale = 1, a.scaleSizeInUnits = 0, a.options.time.unit)
                                ...
                                var s = a.isHorizontal() ? a.width - (a.paddingLeft + a.paddingRight) : a.height - (a.paddingTop + a.paddingBottom),
                                    ...
                                    c = s / (u = u * Math.cos(e.toRadians(a.options.ticks.maxRotation)) + n * Math.sin(e.toRadians(a.options.ticks.maxRotation)));
                                ...
                                for (var h = 0, f = i.units[h]; h < i.units.length;) {
                                    if (a.unitScale = 1, e.isArray(f.steps) && Math.ceil(a.scaleSizeInUnits / c) < e.max(f.steps)) {
                                        for (var g = 0; g < f.steps.length; ++g)
                                            if (f.steps[g] >= Math.ceil(a.scaleSizeInUnits / c)) {
                                                a.unitScale = e.getValueOrDefault(a.options.time.unitStepSize, f.steps[g]);
                                                break
                                            }
                                        break
                                    }
                                    if (!1 === f.maxStep || Math.ceil(a.scaleSizeInUnits / c) < f.maxStep) {
                                        a.unitScale = e.getValueOrDefault(a.options.time.unitStepSize, Math.ceil(a.scaleSizeInUnits / c));
                                        break
                                    }
                                    ++h, f = i.units[h], a.tickUnit = f.name;
                                    var p = a.firstTick.diff(a.getMomentStartOf(a.firstTick), a.tickUnit, !0),
                                        m = a.getMomentStartOf(a.lastTick.clone().add(1, a.tickUnit)).diff(a.lastTick, a.tickUnit, !0);
                                    a.scaleSizeInUnits = a.lastTick.diff(a.firstTick, a.tickUnit, !0) + p + m, a.displayFormat = a.options.time.displayFormats[f.name]
                                }
                            }
                            var b;
                            if (a.options.time.min ? b = a.getMomentStartOf(a.firstTick) : (a.firstTick = a.getMomentStartOf(a.firstTick), b = a.firstTick), !a.options.time.max) {
                                var v = a.getMomentStartOf(a.lastTick),
                                    x = v.diff(a.lastTick, a.tickUnit, !0);
                                x < 0 ? a.lastTick = a.getMomentStartOf(a.lastTick.add(1, a.tickUnit)) : x >= 0 && (a.lastTick = v), a.scaleSizeInUnits = a.lastTick.diff(a.firstTick, a.tickUnit, !0)
                            }
                            a.options.time.displayFormat && (a.displayFormat = a.options.time.displayFormat), a.ticks.push(a.firstTick.clone());
                            for (var y = 1; y <= a.scaleSizeInUnits; ++y) {
                                var k = b.clone().add(y, a.tickUnit);
                                if (a.options.time.max && k.diff(a.lastTick, a.tickUnit, !0) >= 0)
                                    break;
                                y % a.unitScale == 0 && a.ticks.push(k)
                            }
                            0 === a.ticks[a.ticks.length - 1].diff(a.lastTick, a.tickUnit) && 0 !== a.scaleSizeInUnits || (a.options.time.max ? (a.ticks.push(a.lastTick.clone()), a.scaleSizeInUnits = a.lastTick.diff(a.ticks[0], a.tickUnit, !0)) : (a.ticks.push(a.lastTick.clone()), a.scaleSizeInUnits = a.lastTick.diff(a.firstTick, a.tickUnit, !0))), a.ctx.restore(), a.labelDiffs = void 0
                        },
                        getLabelForIndex: function(t, e) {
                            var i = this,
                        ...
                        getPixelForValue: function(t, e, i) {
                            ...
                            if (void 0 !== e && void 0 !== i && (n = a.getLabelDiff(i, e)), null === n && (t && t.isValid || (t = a.parseTime(a.getRightValue(t))), t && t.isValid && t.isValid() && (n = t.diff(a.firstTick, a.tickUnit, !0))), null !== n) {
                                ...
                                if (a.isHorizontal()) {
                                    var r = (a.width - (a.paddingLeft + a.paddingRight)) * o + a.paddingLeft;
                                    return a.left + Math.round(r)
                                }
                                var l = (a.height - (a.paddingTop + a.paddingBottom)) * o + a.paddingTop;
